...
PageMask.tplSet = {
    default:'<div style="display:table; margin: auto; margin-top: 10%; width: 30%; background: #fff"><div style="display:table-row; height:30px; background: #336699; text-align: center; line-height: 30px;color: #fff; font-weight: bold;">${title}<a style="float:right;color: #fff; padding-right: 10px;" href="javascript:PageMask.hide()">X</a></div><div style="display: table-row"><div style="height: 100px; border: 1px solid #336699; text-align: left; display:table-cell; padding: 10px; vertical-align:middle;">${content}</div></div></div>',
